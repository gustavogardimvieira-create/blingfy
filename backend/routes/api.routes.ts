...
router.post('/products/update', validateBlingToken as any, ProductController.updateProduct as any);
router.post('/products/create', validateBlingToken as any, ProductController.createProduct as any);
router.get('/products/check-sku/:sku', validateBlingToken as any, ProductController.checkSku as any);
